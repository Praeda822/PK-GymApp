...
export default function ExerciseCard(props) {
  ...
  // Function to handle incrementing the sets completed
  function handleSetIncrement() {
    setSetsComplete((setsCompleted + 1) % 6);
  }

  return (
    <div className="p-4 rounded-md flex flex-col gap-4 bg-slate-950 sm_flex-wrap">
      <div className="flex flex-col sm:flex-row sm_items-center sm-flex-wrap gap-x-4">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 sm:place-items-center gap-2">
        ...
        <button
          ...
          className="flex flex-col p-2 rounded border-[1.5px] duratin-200 border-solid border-red-900 hover:border-red-600 w-full duration-200"
        >
